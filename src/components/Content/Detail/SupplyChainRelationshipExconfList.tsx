...
import {
  ...
  ExConfsHeaderImage,
} from './SupplyChainRelationshipExconfList.style';
import { DisplayData } from '@/pages/supply-chain-relationship/detail/exconf/list/[userType]/[supplyChainRelationship]';
...
export const SupplyChainRelationshipExconfList = ({ data }: { data: DisplayData; }
) => {
  const contentList = [
    { type: 'General', color: 'blue' },
    { type: 'Delivery', color: 'green' },
    { type: 'Delivery Plant', color: 'blue' },
